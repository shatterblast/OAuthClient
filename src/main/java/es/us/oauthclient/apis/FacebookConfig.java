 ...
 *
 */
public class FacebookConfig extends AbstractOAuth2Config implements OAuth2Config {

  private static final String CLIENTNAME = "facebook";
  ...
  private static final String TOKEN_SERVER_URL = "https://graph.facebook.com/v2.2/oauth/access_token";
  private static final String AUTHORIZATION_SERVER_URL = "https://www.facebook.com/v2.2/dialog/oauth";
